...
public class WeatherActivity extends AppCompatActivity {
    ...
    //获取一些控件的实例，从本地缓存中读取天气数据，第一次肯定没有缓存，
    //因此从Intent中取出天气id，并调用requestWeather()方法从服务器请求
    //天气属性。注意：请求数据的时候先将ScrollView隐藏，不然空数据界面
    // 看上去会很奇怪。
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT>=21){
            ...
            //改变系统UI的显示
            //传入SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN 和
            //SYSTEM_UI_FLAG_LAYOUT_STABLE 表示活动那个的布局
            //会显示在状态栏上面
    ...
    private void showWeatherInfo(Weather weather){
        ...
        //选中某个城市并成功更新天气之后，AutoUpdateService就会一直在后台运行
        //并保证每8小时更新一次天气。
